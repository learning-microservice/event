...
*/
func makeDeleteEventEndpoint(service services.DeleteEventService) gin.HandlerFunc {
	return func(c *gin.Context) {
		input := services.DeleteEventInput{
		...
		//	return
		//}
		output, err := service.Delete(toContext(c), &input)
		if err != nil {
			handleError(c, err)
			return
		}
